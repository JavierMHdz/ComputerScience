...
pframe_shutdown()
{
        ...
        dbg(DBG_TEMP, "returned from pageout thread\n");
        /* Clean all pages (sync with secondary storage) */
        pframe_clean_all();
        dbg(DBG_TEMP, "cleaned all\n");
        /* Free all pages */
        pframe_t *pf;
 ...
 * page before any atnew_vmat to modify its contents. This marks the page dirty
...
pframe_clean_all()
{
        ...
        /*
         * Iterate from head of alloc_list to tail; This is a rough atnew_vmat to
